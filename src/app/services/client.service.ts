...
export class ClientService {
    ...
    CLIENTS: Client[] = [
        { id: 1, name: 'HAMMER', logoImage: this.hammerSvg, url: 'singlestoneconsulting.com' },
        { id: 2, name: 'MALLET', logoImage: this.hammerSvg, url: 'carmaxauctions.com' },
        { id: 3, name: 'HAMMER', logoImage: this.hammerSvg, url: 'singlestoneconsulting.com' },
        { id: 4, name: 'MALLET', logoImage: this.hammerSvg, url: 'carmaxauctions.com' }
    ];
    getClients(): Client[] {
        return this.CLIENTS;
    }
