...
export class ClientService {
    ...
    CLIENTS: Client[] = [
        { id: 1, name: 'HAMMER', logoImage: this.hammerSvg, url: 'http://singlestoneconsulting.com' },
        { id: 2, name: 'MALLET', logoImage: this.hammerSvg, url: 'http://carmaxauctions.com' },
        { id: 3, name: 'HAMMER', logoImage: this.hammerSvg, url: 'http://singlestoneconsulting.com' },
        { id: 4, name: 'MALLET', logoImage: this.hammerSvg, url: 'http://carmaxauctions.com' }
    ];
    getClients(): Client[] {
        return this.CLIENTS;
    }
